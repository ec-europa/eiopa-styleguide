...
1.  Each merged PR should be labeled with one of the [labels](https://github.com/ec-europa/eiopa-styleguide/labels) named `tag: ...` to indicate what kind of change it is.
